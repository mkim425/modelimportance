...
* `model_importance()` calculates the importance score for each model in an ensemble for individual prediction tasks.

* `model_importance_summary()` summarizes these importance scores across multiple tasks to provide an overall importance score for each model.
