...
welcoming, and respectful project environment.
...
spaces. Examples of representing the project include using an official
e-mail address or acting as an appointed representative at an online or
offline event.

## Enforcement

Instances of abusive, harassing, or otherwise unacceptable behavior may
be reported to the project maintainers at <minsu@umass.edu>. All
...
Maintainers will use their judgment in determining the appropriate
response to any behavior they deem in violation of this Code of Conduct:
...
**Response**: A private, written warning from maintainers, providing
...
**Response**: A warning with consequences for continued behavior. No
...
**Impact**: A serious or sustained violation of project standards,
including harassment of an individual or aggression toward classes of
individuals.

**Response**: A temporary or permanent ban from any sort of interaction
or public communication within the project.
