...
Detailed descriptions of the model importance metrics, algorithms, key functions
, and in-depth interpretations of the examples covered here are available in the
accompanying article titled '`modelimportance`: Evaluating model importance 
within a multi-model ensemble in R' under *Articles*.
