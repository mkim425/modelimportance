...
\makeatother
\makeatletter
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[enhanced, boxrule=0pt, breakable, interior hidden, frame hidden, borderline west={3pt}{0pt}{shadecolor}, sharp corners]}{\end{tcolorbox}}\fi
\makeatother
\usepackage{bookmark}
...
difference in accuracy, as measured by a specific score, between
...
value is set to -10, which is an arbitrary choice. Users may choose a
different value based on their practical needs.
...
(Figure~\ref{fig-example-median-lomo}).
