...
Shapley values in cooperative game theory, which measure a player's
average contribution to all possible coalitions (or, equivalently, over
all permutations of players) (\citet{Shapley1953}). Users can choose one
to evaluate the contribution of each model in a manner suited to their
preferred framework.
