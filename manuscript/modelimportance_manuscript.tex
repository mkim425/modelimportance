...
\midrule
mean & SE & Evaluate using the squared error (SE)\\
...
5 2022-11-26      wk flu hosp rate 25               3.17
6 2022-11-26      wk flu hosp rate 48               6.45
7 2022-12-10      wk flu hosp rate 25               8.28
8 2022-12-10      wk flu hosp rate 48               5.95
\end{verbatim}
...
# A tibble: 3 x 2
  model_id          mean_importance
  <chr>                       <dbl>
1 Flusight-baseline          64500.
2 PSI-DICE                   57672.
3 MOBS-GLEAM_FLUH          -117856.
\end{verbatim}
...
# A tibble: 3 x 2
  model_id          mean_importance
  <chr>                       <dbl>
1 Flusight-baseline          65662.
2 PSI-DICE                   54329.
3 MOBS-GLEAM_FLUH          -116761.
\end{verbatim}
