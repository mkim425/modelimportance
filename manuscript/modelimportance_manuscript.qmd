...
#| hospitalizations (top 10 rows) extracted from the `forecast_outputs` data 
#| bundled in the `modelimportance` package, which is originally sourced from 
...
forecast_data_raw <- readRDS("/Users/minsukim/Documents/rpkgs/modelimportance/manuscript/vignette-example-forecast_data.rds")
