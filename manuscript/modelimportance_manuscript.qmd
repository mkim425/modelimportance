...
The examples in this section illustrate the use of the `model_importance()` function to evaluate the importance of component models within an ensemble, using various combinations of the arguments described in Section \ref{sec:main-function}.

### Evaluation using untrained ensemble in LOMO algorithm for  quantile-based forecasts  {#sec:untrained-lomo-qntl}
...
### Evaluation using trained ensemble in LOMO algorithm for mean forecasts  {#sec:trained-lasomo-mean}
