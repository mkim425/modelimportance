...
```{r code-model_importance-summary-lomo-drop, eval=FALSE}
#| eval: false
> scores_lomo <- model_importance(
        forecast_data = forecast_data,
        oracle_output_data = target_data,
...
```{r code-model_importance-summary-lomo-worst, eval=FALSE}
#| eval: false
> model_importance_summary(
        importance_scores = scores_lomo, 
        by = "model_id", 
...
```{r code-model_importance-summary-lomo-avg, eval=FALSE}
#| eval: false
> model_importance_summary(
        importance_scores = scores_lomo, 
        by = "model_id", 
...
\small 
```{r lasomo-NAdrop-equal, eval=FALSE}
#| echo: false
scores_lasomo_eq <- model_importance(
        forecast_data = forecast_data,
        oracle_output_data = target_data,
...
\small 
```{r lasomo-NAdrop-perm, eval=FALSE}
#| echo: false
scores_lasomo_perm <- model_importance(
        forecast_data = forecast_data,
        oracle_output_data = target_data,
